...
public class CategoryControllerImpl implements CategoryController<CategoryDto> {
    ...
    public ResponseEntity<ResponseApi<List<CategoryDto>>> listAll() {
        return ResponseEntity
                .ok(new ResponseApi<>(String.valueOf(HttpStatus.OK), this.categoryService.listAll(), ConstantsApiResponse.GET_DATA_SUCCESS));
    }
    ...
    public ResponseEntity<ResponseApi<CategoryDto>> getById(@PathVariable Long id) {
        return ResponseEntity
                .ok(new ResponseApi<>(String.valueOf(HttpStatus.OK), this.categoryService.getById(id), ConstantsApiResponse.GET_DATA_SUCCESS));
    }
    ...
    public ResponseEntity<ResponseApi<CategoryDto>> create(@RequestBody CategoryDto entity) {
        return ResponseEntity
                .ok(new ResponseApi<>(String.valueOf(HttpStatus.OK), this.categoryService.create(entity), ConstantsApiResponse.GET_DATA_SUCCESS));
    }
    ...
    public ResponseEntity<ResponseApi<List<CategoryDto>>> createMany(@RequestBody List<CategoryDto> entities) {
        return ResponseEntity
                .ok(new ResponseApi<>(String.valueOf(HttpStatus.OK), this.categoryService.createMany(entities), ConstantsApiResponse.GET_DATA_SUCCESS));
    }
    ...
    public ResponseEntity<ResponseApi<CategoryDto>> deleteById( @PathVariable Long id) {
        return ResponseEntity
                .ok(new ResponseApi<>(String.valueOf(HttpStatus.OK), this.categoryService.deleteById(id), ConstantsApiResponse.GET_DATA_SUCCESS));
    }
}
